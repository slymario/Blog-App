        ...
        <>
            ...
            <div className="w-full flex justify-center items-center h-[80vh]">
                <div className="flex flex-col justify-center items-center space-y-4 w-[80%] md:w-[25%]">
                    ...
                    <input className="w-full px-4 py-2 border-black outline-0" type="text" placeholder="Enter your usename" />
                    <input className="w-full px-4 py-2 border-black outline-0" type="text" placeholder="Enter your email" />
                    <input className="w-full px-4 py-2 border-black outline-0" type="password" placeholder="Enter your password" />
